...
// === DEFAULT_URL: shareLink/ssh dari publish (permanen, derive dari AGENTOS_RUNTIME_ID) ===
const DEFAULT_URL = 'https://a98196627af684967.sg.agentos-app.run/ssh';

const WS = globalThis.WebSocket || require('ws'); // Node v22 punya global WebSocket; <22 butuh npm i ws
...
// Mode ProxyCommand (stdin/stdout). WAJIB: buffer stdin sampai ws 'open' supaya
// data awal SSH tidak hilang -> "Bad packet length" dicegah.
...
// Mode listener (default): dengar TCP di 127.0.0.1:port, tiap koneksi buka ws baru.
