...
// Menghubungkan PuTTY/ssh lokal ke server ssh-ws yang dipublikasikan via link permanen.
//
// Mode listener (default):  node ssh-ws-bridge.js [url] [port]
//   dengar 127.0.0.1:<port> -> <url>   (default port 2222)
// Mode stdio (ProxyCommand): node ssh-ws-bridge.js --stdio [url]
//
// url default = DEFAULT_URL di bawah (link permanen + path /ssh).

const net = require('net');
const DEFAULT_URL = 'https://a62f2b92a846ec1b5.sg2.agentos-app.run/ssh';
