...
// Link permanen publish + path /ssh. Awas: trailing slash jangan dobel.
const DEFAULT_URL = 'https://a37c6528913ca7d88.sg.agentos-app.run/ssh';
...
// Mode ProxyCommand: SSH membaca/tulis stdin<->stdout. WAJIB buffer stdin
// sampai ws 'open' (kalau langsung resume stdin sebelum open, data awal SSH
// bisa hilang -> "Bad packet length" di server).
...
// Mode listener: dengar TCP lokal di 127.0.0.1:port, tiap koneksi putar WS baru.
