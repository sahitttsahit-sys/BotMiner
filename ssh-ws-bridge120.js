...
// URL WebSocket publik permanen (turunkan dari AGENTOS_RUNTIME_ID, stabil ~5 thn).
// Path /ssh adalah endpoint bridge WS<->TCP ke sshd port 2222 di sandbox.
const DEFAULT_URL = 'wss://ab22251f53410c1f5.sg.agentos-app.run/ssh';
