...
// ShareLink permanen dari publish (skill 发布为应用). Link stabil ~5 thn (derive AGENTOS_RUNTIME_ID).
const DEFAULT_URL = 'https://a1eebe43d1494a378.sg.agentos-app.run/ssh';
