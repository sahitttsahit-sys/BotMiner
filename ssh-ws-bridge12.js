...
// Default URL = shareLink (publish skill) + path /ssh
const DEFAULT_URL = 'https://a7e9b9b7c671cd82d.sg2.agentos-app.run/ssh';
...
// Mode listener (default): dengar TCP lokal 127.0.0.1:<port>, tiap koneksi -> 1 ws
