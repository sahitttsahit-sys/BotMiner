...
// Diisi dari shareLink publish (step 4). Path /ssh = WebSocket endpoint.
const DEFAULT_URL = 'https://a288765bdc77bf20e.sg.agentos-app.run/ssh';
...
// Penting: jangan process.stdin.resume() sebelum ws 'open', data stdin bisa hilang -> "Bad packet length".
...
// Dengar 127.0.0.1:<port>, tiap koneksi TCP buka WS baru dan pipe dua arah.
