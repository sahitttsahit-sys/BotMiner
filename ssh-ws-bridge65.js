...
const DEFAULT_URL = 'https://ae8f8b977e292b2ea.sg2.agentos-app.run/ssh'; // isi dari step 4
...
// Normalisasi skema: link publik platform itu HTTPS, jadi harus diubah ke wss://
// sebelum dipakai sebagai WebSocket. Tanpa ini: "Invalid URL protocol".
...
function dial(url){ const w = new WS(normalizeWsUrl(url)); try{ if(w.binaryType!==undefined) w.binaryType='arraybuffer'; }catch{} return w; }
