...
// Link permanen hasil publish (Step 4). WebSocket path /ssh.
const DEFAULT_URL = 'https://af5a789b15844cd3f.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global (tanpa dependency npm).
// Untuk Node <22, jalankan: npm i ws  lalu ganti baris bawah dengan require('ws').
...
// Mode --stdio: untuk ssh ProxyCommand (stdin/stdout <-> WebSocket).
...
// Mode listener (default): dengar TCP lokal, tiap koneksi dial WebSocket.
