'use strict';
// ssh-ws-bridge.js — Klien WebSocket<->TCP untuk SSH-over-WS (Node v22, tanpa npm dep)
// Cara pakai:
//   Listener : node ssh-ws-bridge.js [url] [portLocal]   (default url=DEFAULT_URL, port 2222)
//   ProxyCmd : node ssh-ws-bridge.js --stdio [url]
// url harus mengarah ke path /ssh, mis: https://<app>.sg.agentos-app.run/ssh
const net = require('net');
const DEFAULT_URL = 'https://a915596780565cbe4.sg.agentos-app.run/ssh'; // <-- shareLink step 4 + /ssh
