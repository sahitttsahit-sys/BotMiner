...
// === ISI DARI LANGKAH PUBLISH (shareLink/ssh) ===
const DEFAULT_URL = 'https://a6b89ac7d714fe7fd.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global (tanpa dependency npm).
// Untuk Node <22, jalankan: npm i ws  di folder ini, maka require('ws') dipakai otomatis.
...
// Mode --stdio: untuk ProxyCommand (stdin/stdout <-> WS)
...
// Mode listener (default): dengar TCP lokal 127.0.0.1:port -> WS
