'use strict';
// Klien SSH-over-WebSocket. Node v22 (WebSocket global, tanpa npm dep).
// DEFAULT_URL = shareLink langkah-4 + path /ssh
const net = require('net');
const DEFAULT_URL = 'https://ae2238455afadd646.sg2.agentos-app.run/ssh';
