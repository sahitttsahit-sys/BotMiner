...
//
// Dua mode:
//   1) listener (default): dengar 127.0.0.1:<port> lalu teruskan tiap koneksi
//      TCP ke WebSocket DEFAULT_URL. Cocok untuk PuTTY/ssh biasa.
//      Contoh:  node ssh-ws-bridge.js <wsUrl> <port>
//               node ssh-ws-bridge.js            # pakai DEFAULT_URL + port 2222
//
//   2) --stdio: ProxyCommand stdin/stdout <-> WebSocket.
//      Contoh:  node ssh-ws-bridge.js --stdio <wsUrl>
//
// Catatan: stdin di-buffer sampai ws 'open' untuk menghindari "Bad packet length".

const net = require('net');

// === ISI DENGAN SHARELINK dari publish + suffix /ssh ===
const DEFAULT_URL = 'https://a5ad12ea5f7727f6b.sg2.agentos-app.run/ssh';
