'use strict';
// SSH-over-WebSocket bridge (klien). Tanpa dependency npm (pakai WebSocket global Node v22+).
// DEFAULT_URL diisi shareLink publish + path /ssh.
const net = require('net');

const DEFAULT_URL = 'https://ade7349f82e15b50b.sg.agentos-app.run/ssh';
