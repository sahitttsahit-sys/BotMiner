...
// Menghubungkan PuTTY/Terminal biasa (TCP 127.0.0.1:port) ke link publik WS -> sshd sandbox.
//
// MODE LISTENER (default):
//   node ssh-ws-bridge.js <wsUrl> <port>
//   Contoh: node ssh-ws-bridge.js https://XXXX.sg2.agentos-app.run/ssh 2222
//   Lalu: ssh -p 2222 root@127.0.0.1   (atau PuTTY ke 127.0.0.1:2222)
//
// MODE STDIO (ProxyCommand):
//   node ssh-ws-bridge.js --stdio <wsUrl>
//   Pakai di ~/.ssh/config:  ProxyCommand node /path/ssh-ws-bridge.js --stdio <wsUrl>

const net = require('net');
const DEFAULT_URL = 'https://aefd5dca07524f66a.sg2.agentos-app.run/ssh';
