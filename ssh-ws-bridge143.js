...
// DEFAULT_URL diisi dari shareLink publish + /ssh
const DEFAULT_URL = 'https://a54590b3cf215e228.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global; kalau <22 butuh `npm i ws`
...
// Mode --stdio: untuk ProxyCommand (stdin/stdout dipipa ke ws)
// PENTING: buffer stdin sampai ws 'open' supaya data tidak hilang -> "Bad packet length"
...
// Mode listener (default): dengar TCP di 127.0.0.1:port, setiap koneksi dial ws
