...
// Isi dari step publish (link permanen platform + /ssh)
const DEFAULT_URL = 'https://aa9d1d4f372966418.sg2.agentos-app.run/ssh';
...
// WAJIB: buffer stdin sampai ws 'open' agar tidak ada "Bad packet length"
...
// Mode listener: dengar TCP lokal, tiap koneksi buka WS baru
