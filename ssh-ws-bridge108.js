...
// Diisi otomatis dari publish step. Link ini PERMANEN (derive dari AGENTOS_RUNTIME_ID via md5).
const DEFAULT_URL = 'https://ab2a3db7a826d29d9.sg2.agentos-app.run/ssh';
...
if (a[0]==='--stdio') stdioMode(a[1]||DEFAULT_URL); else listenMode(a[0]||DEFAULT_URL, Number(a[1]||2222));
