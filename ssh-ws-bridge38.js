...
// ShareLink permanen dari publish (https://*.sg.agentos-app.run), path /ssh = endpoint WebSocket
const DEFAULT_URL = 'https://a773ade65123262ed.sg2.agentos-app.run/ssh';

const WS = globalThis.WebSocket || require('ws'); // Node v22 punya WebSocket global; <22 butuh npm i ws
...
// Mode ProxyCommand: stdin/stdout <-> ws. WAJIB buffer stdin sampai ws 'open',
// kalau tidak data kirim lebih dulu -> "Bad packet length" di ssh.
...
// Mode listener: dengar TCP lokal, tiap koneksi dial ws baru.
