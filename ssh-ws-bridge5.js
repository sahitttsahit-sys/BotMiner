...
// URL WebSocket publik permanen (turunan dari AGENTOS_RUNTIME_ID platform).
const DEFAULT_URL = 'https://a3e5655f750695810.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global (tanpa dependency npm).
// Untuk Node <22, install `ws` lalu uncomment baris fallback di bawah.
...
// Mode --stdio: untuk ProxyCommand (ssh -o ProxyCommand='node ... --stdio <url>').
// WAJIB buffer stdin sampai ws 'open' agar tidak "Bad packet length".
