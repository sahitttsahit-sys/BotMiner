...
// shareLink permanen dari publish (ganti jika link berubah setelah rebuild baru)
const DEFAULT_URL = 'wss://a9d945a591f61540e.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global; untuk <22 install: npm i ws
...
// Mode ProxyCommand: stdin/stdout <-> ws. Buffer stdin sampai ws open agar
// tidak terjadi "Bad packet length" (data stdin hilang sebelum ws siap).
...
// Mode listener (default): dengar TCP lokal 127.0.0.1:<port>, tiap koneksi
// bikin ws baru ke url. Cocok untuk PuTTY/ssh biasa.
