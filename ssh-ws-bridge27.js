...
// shareLink dari langkah publish (https://a6dafc8e802331f6c.sg2.agentos-app.run)
const DEFAULT_URL = 'https://a6dafc8e802331f6c.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global (undici), jadi tidak butuh dependency npm.
// Untuk Node <22, fallback ke 'ws' (npm i ws).
...
// --- Mode ProxyCommand (stdin/stdout) ---
// WAJIB: jangan panggil process.stdin.resume() sebelum ws 'open',
// data stdin bisa hilang -> "Bad packet length". Buffer dulu sampai open.
...
// Dengar TCP di 127.0.0.1:<port>, tiap koneksi dial WebSocket ke <url>.
