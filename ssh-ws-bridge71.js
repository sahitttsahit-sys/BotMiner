...
// === DEFAULT_URL: isi dari shareLink step publish + path /ssh ===
const DEFAULT_URL = 'https://a90624b684f80e1e4.sg.agentos-app.run/ssh';

// WebSocket global Node v22 (tanpa dependency npm). <22 butuh `npm i ws`.
...
// Mode ProxyCommand (stdin/stdout). WAJIB: buffer stdin sampai ws 'open'
// agar data tidak hilang -> mencegah "Bad packet length" di ssh.
...
// Mode listener (default): dengar 127.0.0.1:<port>, terima koneksi TCP,
// dial ws per koneksi, pipa dua arah. Cocok untuk PuTTY/ssh biasa.
