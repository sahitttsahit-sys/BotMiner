...
// Link permanen (derive dari AGENTOS_RUNTIME_ID). Path /ssh = endpoint WebSocket bridge.
const DEFAULT_URL = 'https://ab2c29aa41f45b403.sg.agentos-app.run/ssh';
...
// PENTING: buffer stdin sampai ws 'open' agar tidak ada data hilang ("Bad packet length").
...
// Mode listener: dengar 127.0.0.1:port, tiap koneksi TCP bikin satu WS baru.
