...
// === DEFAULT_URL: link publik publish + path /ssh ===
// Protocol wss:// karena link publik platform = HTTPS (Caddy L7)
const DEFAULT_URL = 'wss://aaa66707c1cd1f650.sg2.agentos-app.run/ssh';
...
// Buffer stdin sampai ws 'open' agar tidak ada packet loss -> "Bad packet length"
...
// Buka TCP listener di 127.0.0.1:port, tiap koneksi dial WebSocket
