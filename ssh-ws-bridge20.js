...
// DEFAULT_URL = shareLink dari publish + /ssh
const DEFAULT_URL = 'https://aa7130fe073f8a2c4.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global; untuk versi <22 butuh `npm i ws`
...
function stdioMode(url) {
  ...
  // Buffer stdin sampai ws 'open' untuk hindari "Bad packet length"
...
// Mode listener (default): dengar TCP lokal, forward ke ws
  ...
  const tcp = net.createServer(sock => {
    ...
    attach(ws,
      () => {
        ...
        sock.on('error', () => { try { ws.destroy(); } catch {} });
      },
