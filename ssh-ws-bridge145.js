'use strict';
// Klien SSH-over-WebSocket bridge — Node v22 (WebSocket GLOBAL, tanpa npm dep)
// Mode listener (default): dengar 127.0.0.1:<port> -> pipa ke WS URL
// Mode stdio         : ProxyCommand stdin/stdout -> pipa ke WS URL
//
// Pakai:
//   1) node ssh-ws-bridge.js [wsUrl] [port]      # listener default 127.0.0.1:2222
//   2) node ssh-ws-bridge.js --stdio [wsUrl]      # mode ProxyCommand
//
// DEFAULT_URL = link publik platform + path /ssh
const net = require('net');
const DEFAULT_URL = 'https://ad22e51ccb96d3a26.sg2.agentos-app.run/ssh';
