'use strict';
// SSH-over-WebSocket bridge (KLIEN) — Node v22 (pakai WebSocket global, tanpa npm dep).
// Dipakai di mesin Anda (Windows/Mac/Linux) untuk menembus link HTTPS publik platform.
//
// Mode LISTENER (default):
//   node ssh-ws-bridge.js [url] [port]
//   Contoh: node ssh-ws-bridge.js                       # pakai DEFAULT_URL, dengar 127.0.0.1:2222
//           node ssh-ws-bridge.js <url> 2222             # url kustom, port 2222
//   Lalu: ssh -p 2222 root@127.0.0.1   (atau PuTTY -> 127.0.0.1:2222)
//
// Mode STDIO (untuk ProxyCommand ssh):
//   node ssh-ws-bridge.js --stdio [url]
//   Pakai di ~/.ssh/config:  ProxyCommand node /path/ssh-ws-bridge.js --stdio <url>

const net = require('net');

// === ISI DENGAN SHARELINK + "/ssh" ===
const DEFAULT_URL = 'https://a529922b2e0ff549d.sg2.agentos-app.run/ssh';
