...
// === ISI DENGAN SHARELINK PUBLISH (step 4) ===
const DEFAULT_URL = 'https://abffabdecfac6d1a9.sg.agentos-app.run/ssh';
...
// Buffer stdin sampai ws 'open' agar tidak ada data hilang -> "Bad packet length".
...
// --- Mode listener (default, dengar 127.0.0.1:PORT) ---
