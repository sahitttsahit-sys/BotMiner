...
// Mode listener (default) : dengar 127.0.0.1:<port> -> pipa ke WS shareLink/ssh
// Mode --stdio            : ProxyCommand stdin/stdout -> WS shareLink/ssh
//
// Pakai:  node ssh-ws-bridge.js [url] [port]        (default: url=DEFAULT_URL, port=2222)
//         node ssh-ws-bridge.js --stdio [url]       (untuk ssh -o ProxyCommand=...)
const net = require('net');

const DEFAULT_URL = 'https://a56b6462252e72dea.sg.agentos-app.run/ssh'; // isi dari step publish
