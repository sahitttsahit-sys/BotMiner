...
// === GANTI sesuai link permanen Anda (akhiri dengan /ssh) ===
const DEFAULT_URL = 'https://a518b42004c0ed11d.sg2.agentos-app.run/ssh';

// Node v22 punya WebSocket global (tanpa dependency npm). <22 butuh `npm i ws`.
...
// Mode ProxyCommand (stdin/stdout) — dipakai via `ssh -o ProxyCommand='node ssh-ws-bridge.js --stdio URL'`
...
// Mode listener (default) — buka TCP lokal, klien PuTTY/ssh connect ke 127.0.0.1:<port>
